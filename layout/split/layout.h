...
static struct key keys_full[], keys_special[], keys_function[],
...
static struct layout layouts[NumLayouts] = {
    ...
    [Function] = {keys_function, "latin", "special", false},
...
static struct key keys_full[] = {
    ...
    {"⌨͕↓", "⌨͔↓", 1.0, Layout, 0, &layouts[Function], .scheme = 1},
    {"", "", 2.0, Pad},
...
static struct key keys_function[] = {
    ...
    /* BackLayer doesn't work. */
    /* {"⌨͕↓", "⌨͔↓", 1.0, BackLayer, .scheme = 1}, */
    {"⌨͕↓", "⌨͔↓", 1.0, Layout, 0, &layouts[Special], .scheme = 1},
    {"", "", 2.0, Pad},
    {"Cmp", "Cmp", 1.0, Compose, .scheme = 1},
    {"", "", 1.0, Code, KEY_SPACE},
    {"Alt", "Alt", 1.0, Mod, Alt, .scheme = 1},
